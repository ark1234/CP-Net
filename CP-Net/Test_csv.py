...
parser.add_argument('--infile',type = str, default = '/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example/v1test/test-cp-pf/test-example_try602_epoch120_airplane/crop102.csv')
parser.add_argument('--infile_real',type = str, default = '/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example/v1test/test-cp-pf/test-example_try602_epoch120_airplane/real102.csv')
...
# np.savetxt('/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example-ablation/sample-Airplane/crop_ours'+'.csv', np_crop, fmt = "%f,%f,%f")
# np.savetxt('/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example-ablation/sample-Airplane/fake_ours'+'.csv', np_fake, fmt = "%f,%f,%f")
np.savetxt('/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example-ablation/sample-Airplane/crop_ours_txt'+'.txt', np_crop, fmt = "%f,%f,%f")
np.savetxt('/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example-ablation/sample-Airplane/fake_ours_txt'+'.txt', np_fake, fmt = "%f,%f,%f")
np.savetxt('/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example-ablation/sample-Airplane/np_real2_txt'+'.txt', np_real2, fmt = "%f,%f,%f")
np.savetxt('/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example-ablation/sample-Airplane/np_real3_txt'+'.txt', np_real3, fmt = "%f,%f,%f")
np.savetxt('/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example-ablation/sample-Airplane/np_fake1_txt'+'.txt', np_fake1, fmt = "%f,%f,%f")
np.savetxt('/home/ark/local/PF-Net-Point-Fractal-Network-datasets/test-example-ablation/sample-Airplane/np_fake2_txt'+'.txt', np_fake2, fmt = "%f,%f,%f")

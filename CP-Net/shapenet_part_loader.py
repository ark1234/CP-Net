...
dataset_path='/home/ark/local/PF-Net-Point-Fractal-Network-datasets/dataset/shapenet_part/shapenetcore_partanno_segmentation_benchmark_v0/'
...
if __name__ == '__main__':
    dset = PartDataset( root='./dataset/shapenet_part/shapenetcore_partanno_segmentation_benchmark_v0/',classification=True, class_choice=None, npoints=4096, split='train')

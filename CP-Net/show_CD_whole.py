...
parser.add_argument('--netG', default='/home/ark/local/PF-Net-Point-Fractal-Network-datasets/Trained_Model_try602/point_netG180.pth', help="path to netG (to continue training)")

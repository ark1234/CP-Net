...
from utils import distance_squre,AverageValueMeter
import data_utils as d_utils
import ModelNet40Loader
import shapenet_part_loader
from model_PFNet import _netlocalD,_netG
sys.path.append('/home/ark/local/trainningcode/PF-Net-Point-Fractal-Network-try602/ChamferDistancePytorch')
...
parser.add_argument('--netG', default='/home/ark/local/PF-Net-Point-Fractal-Network-datasets/Trained_Model_try602/point_netG170.pth', help="path to netG (to continue training)")
...
#    fake,fake_part = point_netG(input_cropped)
    ...
    _, _,f1 = calc_f1(torch.squeeze(fake,1),torch.squeeze(real_center,1))
    ...
    # emd0 = calc_emd(torch.squeeze(fake,1), torch.squeeze(real_center,1))
    # print(emd0)
    # exit()
    ...
    print(CD,Gt_Pre,Pre_Gt,f1_avg)
print(CD,Gt_Pre,Pre_Gt,f1_avg)
print("CD:{} , Gt_Pre:{} , Pre_Gt:{}, f1_avg:{}".format(float(CD),float(Gt_Pre),float(Pre_Gt),float(f1_avg)))
print(length)    
